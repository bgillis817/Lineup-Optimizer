library(shiny); library(bslib); library(tidyverse); library(reactable)
library(plotly); library(gtools); library(lubridate); library(data.table)
library(htmlwidgets)
# ============================================================================
...
source("build_batter_response.R"); source("matchup_shape.R"); source("shape_pa.R")
options(necbl.shape_mode = TRUE)
